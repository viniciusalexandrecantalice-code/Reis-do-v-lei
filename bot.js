// ===================================================
//   SALA FUTSAL 2v2 / 1v1 / TREINO - HAXBALL HEADLESS
//   Mapa Oficial: Futsal x3 GLH (By Bazinga! - HaxMaps)
// ===================================================

// ---------- MAPAS ----------
// Mapa original do Bazinga
...
// ===================================================
//   MAPA DE TREINO (1 JOGADOR)
//   Quadrado de Treino do Tr7mmm
// ===================================================
...
room.onPlayerJoin = function (player) {
  playerState[player.id] = {
    ...
    originalName: player.name // Salva o nome limpo
  };
...
room.onPlayerChat = function (player, message) {
  ...
  // Zera o tempo de AFK sempre que alguém manda uma mensagem no chat
  ...
  // Se não for mutado, formata a mensagem com a Tag e manda no chat
  if (st && !st.muted) {
    var auth = playerAuth[player.id];
    var s = stats[auth] || defaultStats();
    ...
    // Pinta a mensagem conforme o time do jogador
    var chatColor = 0xFFFFFF; // Branco (Espectador)
    if (player.team === 1) chatColor = 0xFF8888; // Vermelho claro
    if (player.team === 2) chatColor = 0x8888FF; // Azul claro

    room.sendAnnouncement(tagPrefix + cleanName + ": " + message, null, chatColor, "normal", 1);
  }

  return false; // Cancela a mensagem original para usar apenas a formatada com tag
};
...
console.log("Sala dinâmica 1v1/2v2/Treino + Tags no Chat e Time iniciada com sucesso!");